...
export default function App() {
  ...
  const handleCreateClient = async () => {
    ...
    try {
      ...
      setNewClient({ name: "", email: "", color: "#2A8FA8", reseaux: [] });
      fire("✅ Client créé !");
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: C.bg, fontFamily: "'DM Sans', system-ui, sans-serif", color: C.text }}>
      ...
      <div style={{ display: "flex", minHeight: "calc(100vh - 58px)" }}>
        ...
        {/* ─── MAIN ─── */}
        <div style={{ flex: 1, padding: 22, overflowY: "auto", maxHeight: "calc(100vh - 58px)", backgroundImage: "url(https://ggoqdgddsppxrrszqrkm.supabase.co/storage/v1/object/public/post-images/bg-portail.png)", backgroundSize: "cover", backgroundPosition: "center right", backgroundRepeat: "no-repeat", backgroundAttachment: "local" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <div>
                ...
                <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                  {["#2A8FA8","#4A9E62","#C8A06A","#D4886B","#5B8EC4","#1E6E84","#D45B5B","#7CCFDF"].map(col => (
